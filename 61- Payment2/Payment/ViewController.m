...
- (void)viewDidLoad {
    ...
    self.products = @{@"com.photoedit.www_19":@"清峰子",@"com.photoedit.www_19":@"周星星",@"com.photoedit.www_19":@"请我吃鸡腿"};
    ...
    NSLog(@"%s-%ld", __func__,(long)[TTZPay PaymentStateWithProductIdentifier:@"com.photoedit.www_19"]);
    NSLog(@"%s-%ld", __func__,(long)[TTZPay PaymentStateWithProductIdentifier:@"com.photoedit.www_19"]);
    NSLog(@"%s-%ld", __func__,(long)[TTZPay PaymentStateWithProductIdentifier:@"com.photoedit.www_19"]);
...
- (IBAction)Action {
    ...
    [[TTZPay defaultPay] buyWithProductIdentifier:@"com.photoedit.www_19"
