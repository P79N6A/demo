...
/*!
 ...
 @param userinfo (NSDictionary --optional) 用户信息设置  @{MBJoyAccountname: @"user's id"}
 @result MBJoyView的实例
 */
...
/*!
 ...
 @discussion 此方法与mBJoyOnResume相对应。
 */
-(void)mBJoyOnPause;
...
/*!
 ...
 @discussion 此方法与mBJoyOnPause相对应。
 */
-(void)mBJoyOnResume;
